...
![Рисунок 1 - Линейный график: динамика создания тикетов по дням за последние 30 дней](output/timeline_linechart.png)
...
![Рисунок 2 - Столбчатая диаграмма: распределение тикетов по часам суток](output/tickets_by_hour.png)
...
![Рисунок 3 - Тепловая карта: активность по дням недели и часам](output/heatmap_weekday_hour.png)

Тепловая карта демонтрирует наибольший пик активности в субботу.

4. Распределение тикетов по категориям проблем

![Рисунок 4 - Круговая диаграмма: распределение тикетов по категориям проблем](output/pie_categories.png)
...
![Рисунок 5 - Горизонтальная столбчатая диаграмма: среднее время решения](output/resolution_time_by_category.png)
...
![Рисунок 6 - График роста нагрузки на отдел за 7/14/30 дней](output/workload_7_14_30.png)
